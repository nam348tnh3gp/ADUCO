...
void duco_hash_load_block_words(uint32_t *W,
...
// Hàm này sẽ được compiler tự động unroll triệt để toàn bộ 70 vòng
// nhờ attribute "unroll-loops" bên dưới. Không hề thay đổi thuật toán gốc.
...
{
    uint32_t W[16];  // biến cục bộ, an toàn, tránh lỗi như static trước đây
